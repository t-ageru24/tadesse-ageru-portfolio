          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Agricultural-Products-Marketplace/Web-Front-End" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://web-front-end-coral.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Agri-cultural Products MarketPlace</h3>
              <p> Agri-cultural Products Marketplace is a dynamic online platform that
                connects farmers, producers, and consumers, enabling the seamless exchange
                of a wide variety of agricultural products. This marketplace promotes sustainability
                and fair trade by offering locally sourced fruits, vegetables, grains, and more,
                directly from farms to buyers. With an emphasis on quality, transparency, and ethical
                sourcing, the platform provides tools for farmers to reach a broader audience,
                while giving consumers access to fresh, organic, and responsibly grown products.
                It fosters a stronger connection between producers and end-users,
                supporting the agricultural community and healthy, eco-conscious living. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Python(Django)</li> <li>React</li> <li>MongoDB</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/t-ageru24/o_lms" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://o-qfts7e3u3-tadesse-agerus-projects.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>
                An online learning management system (LMS) that streamlines course delivery, student management, and progress tracking. This platform allows instructors to create and organize educational content, while students can easily access courses,
                assignments, and assessments. Featuring interactive learning tools and responsive design, it supports both learners and educators in achieving educational goals efficiently.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/t-ageru24/DataScience" target="\_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Industrial Safety Analysis Project</h3>
              <p>
                The Industrial Safety Analysis Project focuses on evaluating workplace environments to identify and mitigate safety risks. It utilizes data-driven tools and assessments to analyze hazards, ensure compliance with safety regulations, and enhance overall workplace safety. The project aims to prevent accidents, improve safety protocols, and promote a culture of safety in industrial settings.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
