    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Hi there! my name is Tadesse, I am a Full-Stack and Mobile App developer with a passion for creating custom online experiences for my clients. With a skill set including HTML, CSS, JavaScript, Express, React, MongoDB, Dart and Flutter, I have the tools to bring any website vision to life.
          </p>
        </ScrollAnimation>
